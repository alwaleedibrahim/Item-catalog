...
@app.route('/logout')
def logout():
    '''Disconnect and reset login session'''
...
def gdisconnect():
    '''Revoke a current user's token and reset login_session'''
...
def categoryItemsJSON(category_id):
    '''Show JSON of all items in a category'''
...
def editCategory(category_id):
    ...
    if editedCategory.user_id != login_session['user_id']:
        ...
        authorized to edit this category. Please create your own category in
...
def deleteCategory(category_id):
    ...
    if categoryToDelete.user_id != login_session['user_id']:
        return """<script>function myFunction() {alert('You are not
        authorized to delete this category. Please create your own category
...
def deleteItem(category_id, item_id):
    ...
    if login_session['user_id'] != category.user_id:
        return """<script>function myFunction() {alert('You are not
        authorized to delete items to this category. Please create your own
...
if __name__ == '__main__':
    app.secret_key = '''J\x9c\x97\xe4gh\x9bH\xc5\x8e\xbc
                        \xe5\xe6Qm\xdd\xd3b\x07\xb0_\x8a\x07\xfb'''
    app.debug = True
    threaded = False
